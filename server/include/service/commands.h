...
#define CMD_RES_SEARCH_USER     0x020A    // Server → Client: Search results
#define CMD_REQ_GET_FRIEND_INFO 0x020B    // Client → Server: Get friend info with status
#define CMD_RES_GET_FRIEND_INFO 0x020C    // Server → Client: Friend info response
#define CMD_REQ_GET_PENDING_REQ 0x020D    // Client → Server: Get pending friend requests
